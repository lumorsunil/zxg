...
pub const XmlGenParserDvui = struct {
    allocator: Allocator,
    fileName: []const u8,
    ...
    pub fn init(allocator: Allocator, fileName: []const u8, writer: std.fs.File.Writer) XmlGenParserDvui {
        return XmlGenParserDvui{
            .allocator = allocator,
            .fileName = fileName,
            .writer = writer,
    ...
    pub fn deinit(self: *XmlGenParserDvui) void {
    ...
    fn addDocument(self: *XmlGenParserDvui, fileName: []const u8) !*xml.Document {
    ...
    fn readXml(self: *XmlGenParserDvui, fileName: []const u8) !xml.Document {
        const file = try std.fs.cwd().openFile(fileName, .{});
        defer file.close();
        return try xml.parse(self.allocator, fileName, file.reader());
    }

    fn pushDocument(self: *XmlGenParserDvui, fileName: []const u8) !*xml.Document {
    ...
    fn popDocument(self: *XmlGenParserDvui) !void {
    ...
    pub fn xmlGen(self: *XmlGenParserDvui) !void {
    ...
    fn xmlGenNodes(self: *XmlGenParserDvui, nodes: []const xml.NodeIndex) anyerror!void {
        for (nodes) |node| try self.xmlGenNode(node);
    }

    fn xmlGenNode(self: *XmlGenParserDvui, node: xml.NodeIndex) anyerror!void {
        switch (node.v()) {
    ...
    fn xmlGenElement(self: *XmlGenParserDvui, element: xml.Element) anyerror!void {
    ...
    fn xmlGenTextRaw(self: *XmlGenParserDvui, text: []const u8) !void {
    ...
    fn xmlGenZig(self: *XmlGenParserDvui, node: xml.Element) anyerror!void {
    ...
    fn xmlGenElementWithChildren(self: *XmlGenParserDvui, node: xml.Element) anyerror!void {
    ...
    fn xmlGenElementWithoutChildren(self: *XmlGenParserDvui, node: xml.Element) anyerror!void {
    ...
    pub const ColorOrName = union(enum) {
        name: dvui.Options.ColorsFromTheme,
        color: dvui.Color,
    ...
    fn xmlGenBox(self: *XmlGenParserDvui, node: xml.Element) !void {
    ...
    fn xmlGenElementAttributes(self: *XmlGenParserDvui, node: xml.Element) anyerror!void {
    ...
    fn xmlGenText(self: *XmlGenParserDvui, node: xml.Element) !void {
    ...
    fn xmlGenTextVarName(self: *XmlGenParserDvui, varName: []const u8) !void {
        try self.writer.print("@\"text_{s}\"", .{varName});
    }

    fn xmlGenTextString(self: *XmlGenParserDvui, text: []const u8) !void {
        try self.xmlWriter.writeValue([]const u8, text);
    }

    fn xmlGenTagName(self: *XmlGenParserDvui, tagName: []const u8, nodes: []const xml.NodeIndex) !void {
        for (nodes) |node| {
            switch (node.v()) {
    ...
    fn allocImportPath(self: *XmlGenParserDvui, fileName: []const u8) ![]const u8 {
        const importRootDir = "layout";
        return try std.fmt.allocPrint(self.allocator, importRootDir ++ "/{s}", .{fileName});
    }

    fn xmlGenImport(self: *XmlGenParserDvui, element: xml.Element) anyerror!void {
    ...
    fn xmlGenImportZig(self: *XmlGenParserDvui, fileName: []const u8) !void {
    ...
    fn xmlGenImportXml(self: *XmlGenParserDvui, fileName: []const u8) !void {
